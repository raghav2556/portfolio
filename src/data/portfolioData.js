  ...
  skills: [
    {
      category: "Languages",
      items: [
        { name: "C++",    level: null, icon: "cplusplus" },
         { name: "Python", level: null, icon: "python" },
        { name: "C",      level: null, icon: "c" },
        { name: "HTML5",  level: null, icon: "html5" },
        { name: "CSS3",   level: null, icon: "css3" },
        { name: "JavaScript", level: null, icon: "javascript" },
      ],
    },
    {
      category: "Frameworks & Libraries",
      items: [
        { name: "React",          level: null, icon: "react" },
        { name: "Node.js",        level: null, icon: "nodejs" },
        { name: "Express.js",     level: null, icon: "express" },
        { name: "Tailwind CSS",   level: null, icon: "tailwindcss" },
        { name: "Framer Motion",  level: null, icon: null },
      ],
    },
    {
      category: "Databases & Tools",
      items: [
        { name: "MongoDB",                    level: null, icon: "mongodb" },
        { name: "Git & GitHub",               level: null, icon: "github" },
        { name: "Data Structures & Algorithms", level: null, icon: null },
        { name: "Object Oriented Programming", level: null, icon: null },
        { name: "REST APIs", level: null, icon: null },
      ],
    },
  ],
